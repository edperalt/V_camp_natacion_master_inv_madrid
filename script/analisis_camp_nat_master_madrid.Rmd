...
```{r echo=FALSE}
wordcloud2(data=alc_nadadores_num, size=0.4, color='random-dark')
```
...
## Vamos a nadar <span style="color:orange"> `r nrow(cna)` pruebas </span> individuales!!
...
## somos un club super balanceado por edades.....
